...
while [ "$chaincodeCount" -ge 1 ]; do
	...
	ssh sgx6 'cd /opt/intel/sgxsdk/SampleCode/SampleEnclave/; ./chaincode' &
...
while [ "$chaincodeCount" -ge 1 ]; do
	...
	ssh sgx5 'cd /opt/intel/sgxsdk/SampleCode/SampleEnclave/; ./chaincode' &
        chaincodeCount=$(( chaincodeCount - 1 ))
done
...
while [ "$chaincodeCount" -ge 1 ]; do
	...
	ssh sgx4 'cd /opt/intel/sgxsdk/SampleCode/SampleEnclave/; ./chaincode' &
        chaincodeCount=$(( chaincodeCount - 1 ))
done
